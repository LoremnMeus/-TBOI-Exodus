...
local GiantBook_holder = require("EdenAndNether_Extra_scripts.others.GiantBook_holder")
...
--l local item = require("EdenAndNether_Extra_scripts.others.Achievement_Display_holder") item.PlayAchievement("gfx/ui/achievement/holier.png")
