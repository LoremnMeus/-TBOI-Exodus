...
local callback_manager = require("EdenAndNether_Extra_scripts.core.callback_manager")

function manager.Init(mod)
	modReference = mod
	table.insert(manager.items,#manager.items + 1,require("EdenAndNether_Extra_scripts.core.others_manager"))
	table.insert(manager.items,#manager.items + 1,require("EdenAndNether_Extra_scripts.core.callback_manager"))
	table.insert(manager.items,#manager.items + 1,require("EdenAndNether_Extra_scripts.core.grid_manager"))
	table.insert(manager.items,#manager.items + 1,require("EdenAndNether_Extra_scripts.core.enemy_manager"))
	manager.Make(mod)
end
