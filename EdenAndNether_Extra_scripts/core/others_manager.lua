...
function Others_manager.Init(mod)
	...
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Console_holder"))
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Dropping_holder"))
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Attribute_holder"))
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Charging_Bar_holder"))
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Costume_holder"))
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Consistance_holder"))
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Base_holder"))
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Apple_holder"))
	table.insert(Others_manager.items,#Others_manager.items + 1,require("EdenAndNether_Extra_scripts.others.Room_holder"))
